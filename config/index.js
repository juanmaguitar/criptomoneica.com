module.exports = {
  ...
  siteDescription: 'Apuntes sobre Blockchain y Criptomonedas', // Your site description
  author: 'LekoArts', // Author for schemaORGJSONLD
  siteLogo: '/social/_logo.jpg', // Image for schemaORGJSONLD

  // siteFBAppID: '123456789', // Facebook App ID - Optional
  userTwitter: '@criptomoneica', // Twitter Username - Optional
